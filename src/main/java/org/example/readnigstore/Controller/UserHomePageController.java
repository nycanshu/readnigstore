...
import javafx.scene.layout.TilePane; // Use TilePane instead of VBox
import javafx.scene.layout.VBox;
import javafx.stage.Stage;
import org.example.readnigstore.Helper.AlertBoxes;
import org.example.readnigstore.Model.Book; // Ensure you have a Book model
...
public class UserHomePageController {
    ...
    public TilePane popularBooksList; // Change to TilePane to hold books
    public ScrollPane popularBooksScrollPane; // This remains for scrolling
    public Button home;
    public Button allbooks;
    ...
    public void init(User user) {
        ...
        populatePopularBooks(); // Call to populate books on initialization
    }

    private void populatePopularBooks() {
        List<Book> popularBooks = bookService.loadTop5Books(); // Retrieve the top 5 popular books
